...
######################################################################
module "vpc" {
  source               = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/vpc"
...
module "flow_log" {
  source                    = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/flow_log"
  standard_tags             = var.standard_tags
...
module "subnet" {
  source                  = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/subnet"
  standard_tags           = var.standard_tags
...
module "security_group" {
  source             = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/security_group"
  standard_tags      = var.standard_tags
...
module "route_table" {
  source              = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/route_table"
...
module "internet_gateway" {
  source                = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/internet_gateway"
...
module "nat_gateway" {
  source          = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/nat_gateway"
...
module "elb" {
  source                     = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/elb"
  standard_tags              = var.standard_tags
...
module "auto_scaling" {
  source                                  = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/auto_scaling"
...
module "launch_configuration" {
  source                                 = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/launch_configuration"
...
module "cloudwatch" {
  source                         = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modulescloudwatch"
  standard_tags                  = var.standard_tags
...
module "iam" {
  source                    = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/iam"
  iam_flow_logs_assume_role = var.iam_flow_logs_assume_role
  iam_flow_logs_policy      = var.iam_flow_logs_policy
}

module "kms" {
  source                      = "git::https://github.com/oliverjfletcher/aws-terraform/env/web-application/modules/kms"
