...
######################################################################
module "vpc" {
  source               = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/vpc"
...
module "flow_log" {
  source                    = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/flow-log"
  standard_tags             = var.standard_tags
...
module "subnet" {
  source                  = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/subnet"
  standard_tags           = var.standard_tags
...
module "security_group" {
  source             = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/security-group"
  standard_tags      = var.standard_tags
...
module "route_table" {
  source              = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/route-table"
...
module "internet_gateway" {
  source                = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/internet-gateway"
...
module "nat_gateway" {
  source          = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/nat-gateway"
...
module "elb" {
  source                     = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/elb"
  standard_tags              = var.standard_tags
...
module "auto_scaling" {
  source                                  = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/auto-scaling"
...
module "launch_configuration" {
  source                                 = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/launch-configuration"
  ...
  launch_configuration_encrypted         = var.launch_configuration_encrypted
  launch_configuration_iops              = var.launch_configuration_iops
  launch_configuration_throughput        = var.launch_configuration_throughput
  launch_configuration_volume_size       = var.launch_configuration_volume_size
  launch_configuration_volume_type       = var.launch_configuration_volume_type
  launch_configuration_http_tokens       = var.launch_configuration_http_tokens
}


module "cloudwatch" {
  source                         = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/cloudwatch"
  standard_tags                  = var.standard_tags
...
module "iam" {
  source                    = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/iam"
  iam_flow_logs_assume_role = var.iam_flow_logs_assume_role
  iam_flow_logs_policy      = var.iam_flow_logs_policy
}

module "kms" {
  source                      = "git@github.com:oliverjfletcher/aws-terraform.git?ref=dev//env/web-application/modules/kms"
